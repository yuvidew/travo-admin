...
import { useUpdateTripPublish } from "@/app/(dashboard)/trips/[id]/hook/useTrip";
...
export const SiteHeader = ({
    ...
    const { mutate , isPending} = useUpdateTripPublish()
    return (
                    ...
                    <>
                        ...
                        <div
                            className={cn(
                                ...
                                is_Show_Publish ? "flex" : "hidden"
                            )}
                        >
                            <Button 
                                variant="default" 
                                size="sm"
                                onClick={() => mutate(trip_id as number)}
                            >
                                {isPending ? 
